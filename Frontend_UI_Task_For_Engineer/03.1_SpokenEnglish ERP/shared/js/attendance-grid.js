class AttendanceGrid {
    ...
    initDOM() {
        ...
        this.container.innerHTML = `
            <style>
                ...
                .ag-grid-container { background: var(--bg-card, rgba(255,255,255,0.85)); backdrop-filter: blur(12px); border-radius: 16px; border: 1px solid var(--border-neon, rgba(255,255,255,0.4)); overflow-x: auto; overflow-y: visible; max-width: 100%; position: relative; transition: opacity 0.3s; }
                ...
                .ag-table { border-collapse: separate; border-spacing: 0; width: 100%; min-width: max-content; color: var(--text-main, #1a1a1a); }
                .ag-table th, .ag-table td { padding: 4px; border-bottom: 1px solid var(--border-neon, rgba(0,0,0,0.08)); border-right: 1px solid var(--border-neon, rgba(0,0,0,0.08)); text-align: center; min-width: 32px; }
                .ag-table th { background-color: var(--primary-dark, var(--primary-blue, #304587)); color: white; font-weight: 500; font-size: 0.8rem; position: sticky; top: 0; z-index: 2; white-space: nowrap; }
                ...
                .ag-table td:first-child { background-color: var(--bg-card, #fafafa); border-right: 2px solid var(--border-neon, rgba(0,0,0,0.08)); }
                .ag-table th:first-child { z-index: 5; }
                
                .ag-sticky-right-1 { position: sticky; right: 52px; z-index: 3; background-color: #e6f4ea !important; color: #137333 !important; font-weight: bold; border-left: 2px solid var(--border-neon, rgba(0,0,0,0.08)); min-width: 36px; font-size: 0.85rem; text-shadow: none !important; }
                .ag-sticky-right-2 { position: sticky; right: 0; z-index: 3; background-color: #fce8e6 !important; color: #c5221f !important; font-weight: bold; min-width: 36px; font-size: 0.85rem; text-shadow: none !important; }
                .ag-table th.ag-sticky-right-1, .ag-table th.ag-sticky-right-2 { z-index: 5; background-color: var(--primary-dark, var(--primary-blue, #304587)) !important; color: white !important; font-size: 0.8rem; text-shadow: none !important; }
                
                .ag-table tbody tr:hover td { background-color: rgba(255, 255, 255, 0.05); }
                .ag-table tbody tr:hover td:first-child { background-color: rgba(255, 255, 255, 0.1); }
    ...
    renderGrid() {
        ...
        this.students.forEach(student => {
            ...
            tdName.innerText = `${firstName} ${lastName}`.trim();
